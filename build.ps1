...
$args = @('/nologo','/codepage:65001','/target:winexe','/platform:anycpu','/optimize+',"/out:$out",
  '/r:System.Windows.Forms.dll','/r:System.Drawing.dll','/r:System.Web.Extensions.dll','/r:System.IO.Compression.dll','/r:System.IO.Compression.FileSystem.dll',"/r:$fw\WPF\UIAutomationClient.dll","/r:$fw\WPF\UIAutomationTypes.dll","/r:$fw\WPF\WindowsBase.dll")
